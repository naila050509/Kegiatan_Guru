<?php
// Koneksi ke database
$conn = new mysqli("localhost", "root", "", "bootstarp");
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ms-2" src="assets/images/faces/face8.jpg" alt="Profile image"> <span class="font-weight-normal">Naila Aribah Zahra</span></a>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">Naila Aribah</p>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Admin</h4>
                        ...
                        <?php
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              ?>
                              <div class="badge <?php echo $badgeClass; ?> p-2">
                                <?php echo $row['status'] ?>
                              </div>
                            <td>
                              <?php if ($row['status'] == 'approved') : ?>
                                <a href="../proses.php?id=<?= $row['id'] ?>&aksi=approve" class="btn btn-sm btn-success">Edit</a>
                                <a href="../proses.php?id=<?= $row['id'] ?>&aksi=pending" class="btn btn-sm btn-danger">Hapus</a>
                              <?php elseif ($row['status'] == 'pending') : ?>
                                <a href="../proses.php?id=<?= $row['id'] ?>&aksi=approve" class="btn btn-sm btn-success">Approve</a>
                                <a href="../proses.php?id=<?= $row['id'] ?>&aksi=pending" class="btn btn-sm btn-danger">Reject</a>
